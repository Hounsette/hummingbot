...
from hummingbot.connector.connector.polkadex.polkadex_in_flight_order import PolkadexInFlightOrder
...
class PolkadexConnector(ConnectorBase):
    """
    PolkadexInFlightOrder connects with polkadex gateway APIs and provides pricing, user account tracking and trading
    functionality.
    """
    ...
    def __init__(self,
                 polkadex_wallet_address: str,
                 polkadex_wallet_seeds: str,
        ...
        """
        super().__init__()
        self._polkadex_wallet_address = polkadex_wallet_address
        self._polkadex_wallet_seeds = polkadex_wallet_seeds
    ...
    async def _create_order(self,
        ...
        api_params = {"base": base,
                      ...
                      "amount": str(amount),
                      "privateKey": self._polkadex_wallet_seeds,
                      # "maxPrice": str(price),
                      }
        ...
        try:
            ...
            self.logger().network(
                f"Error submitting {trade_type.name} order to polkadex for "
    ...
    def start_tracking_order(self,
        ...
        """
        self._in_flight_orders[order_id] = PolkadexInFlightOrder(
    ...
    async def _update_balances(self):
        ...
        resp_json = await self._api_request("post",
                                            "terra/balances",
                                            {"address": self._polkadex_wallet_address})
    ...
    @property
    def in_flight_orders(self) -> Dict[str, PolkadexInFlightOrder]:
